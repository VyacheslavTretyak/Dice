<div id="divReg">	
	<table id="tabReg" align="center">
		<tr class="lineTabReg">
			...
			<td align="left"><input class="inp reg" type="text" id="iLogin" size="16" maxlength="32"/></td>
		...
		<tr class="lineTabReg">
			...
			<td align="left"><input class="inp reg" type="text" id="iEmail" size="16" maxlength="32" autofocus="true"/></td>
			<td><div class="mesReg errLogin" id="eEmail">**NOTEMAIL**</div></td>                          
		</tr>		
		<tr class="lineTabReg">
			<td align="right">**PASSWORD** :</td>
			<td align="left"><input class="inp reg" type="password" id="iRegPass" size="16" maxlength="16"/></td> 
			<td><div class="mesReg errLogin" id="eRegPass">**PASSSHORT**</div></td>           
		</tr>
		<tr class="lineTabReg">
			<td align="right">**CONFPASSWORD** :</td>
			<td align="left"><input class="inp reg" type="password" id="iConfirm" size="16" maxlength="16"/></td> 
